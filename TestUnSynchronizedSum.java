...
public class TestUnSynchronizedSum {
	...
	static  UnSyncThreadAddOne UnSync = new UnSyncThreadAddOne();
	...
	public static void main(String[] args) {
		...
		//while loop prints final sum after checking for shutdown
			    ...
			    System.out.println("Non Synched sum: " + UnSync.sum);
			  }
	}

class UnSyncThreadAddOne{
	/**
	 * This method will increment one to the sum from each of the 1000 threads
	 * will sleep for 5 milliseconds to prove un_synchronization
	 * @param 1 is passed through from runnable class
	 */
	public Integer sum = 0;
	
	public  void increment(int one) {
	try {
		Thread.sleep(5);
	}
